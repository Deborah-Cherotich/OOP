class Account:
    ...
    def deposit_money(self, amount, pin):
        if pin == self.__pin:
    ...
    def withdraw_money(self, amount, pin):
        if pin == self.__pin and self.__balance >= amount:
            ...
            return "Insufficient funds or wrong pin."
    ...
    def apply_interest(self, pin):
        if pin == self.__pin:
            ...
            return f"Interest of {interest} applied successfully."
        else:
          return "Wrong pin"
    ...
    def freezing_account(self, pin):
        if pin == self.__pin:
            self.freeze = True
            return "freeze account successfully."
        else:
          return "Wrong pin"
